...
import project2 from "../assets/projects/devDetective.png";
import project3 from "../assets/projects/weather.png";
import project4 from "../assets/projects/password.png";
import project5 from "../assets/projects/razorPayClone.png";
import project6 from "../assets/projects/discord.png";
import project7 from "../assets/projects/hangman.png";
import project8 from "../assets/projects/snakeGame.png";
import project9 from "../assets/projects/rpsGame.png";

export const HERO_CONTENT = `I am a skilled full-stack developer with experience in building web applications using the MERN stack (MongoDB, Express, React, Node.js), along with technologies like HTML, CSS, and Tailwind. My goal is to apply my skills to create efficient and scalable solutions that sustain business growth and improve user experiences.`;
...
export const PROJECTS = [
  ...
  // },
  {
	...
	githubPage: "https://amantoor17.github.io/animated-portfolio/",
  },
  {
  ...
  },
  {
    ...
    technologies: ["HTML", "CSS", "JavaScript"],
	githubPage: "https://amantoor17.github.io/Password-generator/",
  },
  {
    title: "RazorPay Clone",
    image: project5,
    description:
      "A website that is a clone of the RazorPay website using Tailwind CSS.",
    technologies: ["HTML", "CSS", "Tailwind"],
	githubPage: "https://amantoor17.github.io/razor-pay/",
  },
  {
    title: "Discord Clone",
    image: project6,
    ...
    technologies: ["HTML", "CSS", "Tailwind"],
	githubPage: "https://amantoor17.github.io/discord-clone/",
  },
  {
    title: "Hangman Game",
    image: project7,
    description:
      "This Hangman game offers hints to help guess the word. Correct guesses are praised, while incorrect ones lead to the drawing of the hangman figure.",
    technologies: ["HTML", "CSS", "JavaScript"],
	  githubPage: "https://amantoor17.github.io/hangman-game/",
  },
  {
    title: "Snake Game",
    image: project8,
    description:
      "Created a Snake game where players control a growing snake to collect food. The game provides feedback on progress, with each successful food collection extending the snake, and the game ends if the snake hits the wall or itself.",
    technologies: ["HTML", "CSS", "JavaScript"],
	  githubPage: "https://amantoor17.github.io/snake-game/",
  },
  {
    title: "Rock-Paper-Scissors Game",
    image: project9,
    description:
      " Created a Rock Paper Scissors game where players compete against the computer. Each round provides immediate feedback on whether the player wins, loses, or ties",
    technologies: ["HTML", "CSS", "JavaScript"],
	  githubPage: "https://amantoor17.github.io/rock-paper-scissors/",
  },
];

export const CONTACT = {
  phoneNo: "+91 9717665748",
  email: "amantoordpps@gmail.com",
};
